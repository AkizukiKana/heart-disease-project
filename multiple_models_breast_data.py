...
data = pd.read_csv('breast_cancer_diagnostic_dataset.csv')
print(data)
...
samples = arr[:, 2:-1] #all but first two columns and the last column
labels = arr[:, 1] # second column only

#need to swtich 'B' to 0 and 'M' to 1
